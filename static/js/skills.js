// Skills UI logic — works for both project skills and user skills.
// The skills-container data attribute determines the mode:
//   data-project-id  → project skills (/projects/<id>/skills/...)
//   data-user-id     → user skills    (/users/<id>/skills/...)
(function () {
  document.addEventListener("DOMContentLoaded", () => {
    ...
    function autocompleteUrl(q) {
      if (userId) return `/users/skills/?q=${encodeURIComponent(q)}`;
      return `/projects/skills/?q=${encodeURIComponent(q)}`;
    }

    function addUrl() {
      if (userId) return `/users/${userId}/skills/add/`;
      return `/projects/${projectId}/skills/add/`;
    }

    function removeUrl(skillId) {
      if (userId) return `/users/${userId}/skills/${skillId}/remove/`;
      return `/projects/${projectId}/skills/${skillId}/remove/`;
    }
